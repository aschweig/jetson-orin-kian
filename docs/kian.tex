...
a 4-bit 4B-parameter model on an 8\,GB Jetson achieves sub-200\,ms mean time-to-first-token,
while leaving enough headroom for a full speech pipeline and safety classifier.
We consider \textbf{Qwen3-4B-Instruct-2507} and \textbf{Granite 4.0 H-Micro} to be strong candidates for this use case.
The former offering natural-feeling conversations and the latter a low factual error rate;
while both producing sufficiently fast inference to maintain engagement.
