...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Content Filtering.}
    ...
    On match, generation halts immediately and the conversation context is reset.
...
\noindent The n-gram filter list is maintained as a plain text file,
making it straightforward for educators and parents to review and extend.
...
All models were evaluated with a 2048-token context window across 5 benchmark runs (100 samples per model).
...
All models use Q4\_K\_M quantization and 2048-token context.}
\label{tab:perf}
\end{table}
